...
@section('contentHeaderLink')
    <a href="{{ route('admin.store.index') }}">فئات الفواتير</a>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.store.create') }}" class="btn btn-sm btn-success p-2">اضافة فئة جديدة</a>
                </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @forelse($data as $Treasurie)
                                    <tr>
                                        ...
                                        <td>{{ $Treasurie->phones }}</td>
                                        <td>{{ $Treasurie->address }}</td>
                                        <th>
                                        ...
                                        <td class="mx-auto text-center">
                                            <a href="{{ route('admin.store.destroy',$Treasurie->id) }}" id="are_you_sure" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                            <a href="{{route('admin.store.edit',$Treasurie->id)}}" data-id="{{ $Treasurie->id }}" class="btn btn-sm btn-info m-1"><i class="fa fa-edit"></i></a>
                                        </td>
