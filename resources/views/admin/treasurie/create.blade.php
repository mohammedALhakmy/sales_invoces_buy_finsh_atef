        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">اضافة خزنة جديدة </h3>
                </div>
                <!-- /.card-header -->
                        ...
                        @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder=" اسم الخزنة"  required>
                                </div>
                                @error('name')
                                ...
                                <div class="form-group m-2">
                                    ...
                                    <label for="is_master"  class="m-2">رئيسية <input type="radio" @if(old('is_master') == 1) checked @endif name="is_master" value="1"> </label>
                                    <label for="is_master" class="m-2">فرعية<input type="radio" @if(old('is_master') == 0) checked @endif  name="is_master" value="0"> </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('last_isal_exchange') }}" oninput="this.value=this.value.replace(/[^0-9]/g,'')" name="last_isal_exchange" placeholder="اخر ارقم ايصل صرف لهذه الخزنة"  required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('last_isal_collect') }}" oninput="this.value=this.value.replace(/[^0-9]/g,'')" name="last_isal_collect" placeholder="اخر ارقم ايصل تحصيل نقدية لهذه الخزنة  "  required>
                                </div>
